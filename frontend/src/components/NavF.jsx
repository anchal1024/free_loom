  ...
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 z-50 w-[1402px] h-[70px] bg-[#F8F2E4] rounded-[6px] flex items-center justify-between px-8 shadow-md">
      ...
      <div className="flex gap-16 absolute left-1/2 -translate-x-1/2">
        <button className="font-Akatab-ExtraBold font-extrabold text-xl text-black cursor-pointer" onClick={() => navigate('/homef')}>
          HOME
        </button>
        ...
        <button className="font-Akatab-ExtraBold font-extrabold text-xl text-black cursor-pointer " onClick={()=> navigate('/dashboard')}>
          FIND WORK
        </button>
      </div>
